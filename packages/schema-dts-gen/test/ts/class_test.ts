...
import { Literal, NamedNode, Quad, type Term } from "n3";
	...
	describe("Two regulars", () => {
		...
		it("DataType comes first", () => {
			...
			expect(
				Sort(
					new DataTypeUnion(
						new NamedNode("https://schema.org/DataType"),
						[]
					),
					new AliasBuiltin(
